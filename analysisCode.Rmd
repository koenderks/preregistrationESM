...
```{r Performing frequentist test for fixed effects in model 1}
...
.plotInfluenceOfPriors(coef = "PP", fit1_f, fit1_bni, fit1_bi, 
                    ...
                    priors = c("Non-informative ~ N(0, 10) prior", "Informative ~ N(-.26,.25) prior"),
                    xmin = -5, xmax = 5, ymax = 3)
...
.plotInfluenceOfPriors(coef = "INEG", fit1_f, fit1_bni, fit1_bi, 
                    ...
                    priors = c("Non-informative ~ N(0, 10) prior", "Non-informative ~ N(0, 10) prior"),
                    xmin = -5, xmax = 5, ymax = 3)

```

```{r Plotting posterior distributions of individual differences in model 1, fig.height = 5, fig.width = 15}
